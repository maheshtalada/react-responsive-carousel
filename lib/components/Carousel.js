...
module.exports = React.createClass({
    ...
    renderItems: function renderItems() {
        ...
        return React.Children.map(this.props.children, function (item, index) {
            ...
            var itemClass = type === 'fade' ? klass.ITEM_FADE(true, index === _this3.state.selectedItem) : klass.ITEM(true, index === _this3.state.selectedItem);
    ...
    renderThumbs: function renderThumbs() {
        ...
        return React.createElement(
            Thumbs,
            { onSelectItem: this.handleClickThumb, selectedItem: this.state.selectedItem, isSlide: this.props.slideThumbs },
            this.props.children
        );
    },
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'button',
                    { type: 'button', className: klass.ARROW_PREV(!hasPrev), onClick: this.decrement },
                    React.createElement('i', { className: 'pe-7s-angle-left-circle' })
                ),
                React.createElement(
                    'div',
                ...
                React.createElement(
                    'button',
                    { type: 'button', className: klass.ARROW_NEXT(!hasNext), onClick: this.increment },
                    React.createElement('i', { className: 'pe-7s-angle-right-circle' })
                ),
                this.renderControls(),
                this.renderStatus()
            ),
